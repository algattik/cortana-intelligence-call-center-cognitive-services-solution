...
namespace ContosoInsurance_CallCenterDemo
{
    ...
    public class Synthesize
    {
        ...
        /// The ssml template
        /// </summary>
        private const string SsmlTemplate = "<speak version='1.0' xml:lang='de-DE'><voice xml:lang='{0}' xml:gender='{1}' name='{2}'>{3}</voice></speak>";
    ...
    public class TextToSpeech
    {
        ...
        public static void Talk(string message, string recoLanguage = "en-US") //string language="English")
        {
            ...
            string VoiceName_str = "";
            if (recoLanguage == "en-US")
                VoiceName_str = "Microsoft Server Speech Text to Speech Voice (en-US, ZiraRUS)";
            else if (recoLanguage == "zh-CN")
                VoiceName_str = "Microsoft Server Speech Text to Speech Voice (zh-CN, HuihuiRUS)"; // This is female voice, other options are (zh-CN, Kangkang, Apollo) - Male or (zh-CN, HuihuiRUS) or (zh-CN, Yaoyao, Apollo)
